...
/*--------------------------------------------------------------------------------------------
                                    BetterBrime Data
---------------------------------------------------------------------------------------------*/
    fetch('https://api.betterbri.me/v1/brime/global/emotes')
                            ...
                            img.innerHTML = img.innerHTML.replace(/(https?:\/\/[^\s]+)/g, function(url) {
                                `<div class="emoteInfo">
                                    ...
                                    <span class="tooltiptext p-1" style="text-align:center;">
                                        <img src="${url}"/><br/>
                                        <br/><small style="color:#553bde;">Image Preview</small>
                                    </span>
                                </div> `;
                            })
                        })
                            ...
                            for (var i = 0; i < emotesList.length; i++) {
                                ...
                                <div class="emoteInfo">
                                    ...
                                    <span class="tooltiptext p-1" style="text-align:center;">
                                        ...
                                        <h4>${imgurID[0]}</h4>
                                        <img src="${chrome.extension.getURL('/assets/icons/32.png')}">
                                        <br/><small style="color:#553bde;">Global</small>
                                    </span>
                                </div> `);
                            }
                            if(channelList != 'false'){
                                for (var i = 0; i < channelList.length; i++) {
                                    ...
                                    <div class="emoteInfo">
                                        ...
                                        <span class="tooltiptext p-1" style="text-align:center;">
                                            ...
                                            <h4>${imgurID[0]}</h4>
                                            <img src="${chrome.extension.getURL('/assets/icons/32.png')}">
                                            <br/><small style="color:#553bde;">Channel</small>
                                        </span>
                                    </div> `);
                                }
                            }
                        ...
                        Array.from(node.querySelectorAll("a[style='font-size: 13px; color: inherit;']")).forEach(img => {
                            for (var i = 0; i < badgeList.length; i++) {
                                ...
                                if(imgurID[1] === ''){
                                    ...
                                    img.innerHTML = img.innerHTML.replace(new RegExp(imgurID[0] + '( |$)', 'g'), ` <img alt="${imgurID[1]}" class="chatBadge" style="height: 1.20em; vertical-align: middle;" src="https://cdn.betterbri.me/badges/${imgurID[1]}.png"> <strong style="color:#${imgurID[2]}">${imgurID[0]}: </strong>`);
                                }
                            }
                        })
                        Array.from(node.querySelectorAll('span[style="font-size: 13px;"] a')).forEach(img => {
                        ...
                        Array.from(node.querySelectorAll("span[style='margin-left: -3px;']")).forEach(img => {
                                if(localStorage.BBTimestamps === 'true' && splitcurrentUrl[4] !== 'chat'){
                                    if(localStorage.BBTimestampstype === 'vod'){
                                        ...
                                        img.innerHTML = img.innerHTML.replace(new RegExp(img.innerHTML +'( |$)', 'g'), `<b class="timestamp">${gimmeTime()}</b> ${img.innerHTML}`);
                                    }
                                }
                        })
                    })
...
function logging(w, m) {
    console.log(`%cBetterBrime [%c${w}%c]:%c ${m}`, 'color:#553bde; font-weight:bold', '', 'color:#553bde; font-weight:bold', '')
}